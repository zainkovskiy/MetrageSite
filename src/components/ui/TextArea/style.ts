...
import { ITextAreaStyleProps } from './type';

export const TextAreaContainer = styled.div<ITextAreaStyleProps>`
  display: flex;
  flex-direction: column;
`;
export const TextArea = styled.textarea<ITextAreaStyleProps>`
  resize: none;
  padding: 13px 16px;
